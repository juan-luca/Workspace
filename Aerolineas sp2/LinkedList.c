...
LinkedList* ll_filter(LinkedList* ll, int (*pFunc)(void*))
{
    ...
    if(ll != NULL &&len>0)
    {
        ...
        if(llAux != NULL)
        {
            for(int i=0; i<len; i++)
            {
                ...
                if(auxpElement!=NULL)
                {
                    if(pFunc(auxpElement)==1)
                    {
                        ll_add(llAux,auxpElement);
                    }
                }
...
LinkedList* ll_filter_parametro(LinkedList* ll, int (*pFunc)(void*,char*),char* nombrePiloto)
{
    LinkedList* llAux = NULL;
    void* auxpElement = NULL;
    ...
    if(ll != NULL &&len>0)
    {
        ...
        if(llAux != NULL)
        {
            for(int i=0; i<len; i++)
            {
                ...
                if(auxpElement!=NULL)
                {
                    if(pFunc(auxpElement,nombrePiloto)==1)
                    {
                        ll_add(llAux,auxpElement);
                    }
                }
...
int ll_count(LinkedList* ll, int (*pFunc)(void*))
{
